...
InterpolatorsVertex MyVertexProgram (VertexData v) {
	...
	UNITY_INITIALIZE_OUTPUT(Interpolators, i);      // might have to switch things up here
...
void ApplySubtractiveLighting (Interpolators i, inout UnityIndirect indirectLight)
{
	...
	float3 subtractedLight = indirectLight.diffuse - shadowLightEstimate;
...
#define PARALLAX_RAYMARCHING_SEARCH_STEPS 0
	...
	float t = prevDifference / (prevDifference + difference + 0.001);
